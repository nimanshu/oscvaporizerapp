...
@XmlRootElement(name = "getEntityListAsyncResponse")
public class GetEntityListAsyncResponse {

    protected List<ServiceViewInfo> result;
     ...
     * 
     */
    public List<ServiceViewInfo> getResult() {
        if (result == null) {
            result = new ArrayList<ServiceViewInfo>();
        }
        return this.result;
    }

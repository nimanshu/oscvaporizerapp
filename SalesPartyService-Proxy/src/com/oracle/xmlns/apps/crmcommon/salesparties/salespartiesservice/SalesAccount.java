...
import com.oracle.xmlns.apps.cdm.foundation.parties.groupservice.Group;
...
import com.oracle.xmlns.apps.crmcommon.assetimport.publicmodel.assetimportservice.Asset;
 ...
 *         &lt;element name="Route_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="VisitFreq_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SalesAccount", propOrder = {
    "accountDirectorId",
    "cpdrfLastUpd",
    "cpdrfVerPillar",
    "cpdrfVerSor",
...
public class SalesAccount {
    ...
    @XmlElementRef(name = "AccountDirectorId", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<Long> accountDirectorId;
    ...
    @XmlElement(name = "UserSalesAccountId")
    protected Long userSalesAccountId;
    ...
    @XmlElement(name = "InternalStatus")
    ...
    @XmlElementRef(name = "Route_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<String> routeC;
    @XmlElementRef(name = "VisitFreq_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> visitFreqC;
     ...
     *     
     */
    public JAXBElement<Long> getAccountDirectorId() {
     ...
     *     
     */
    public void setAccountDirectorId(JAXBElement<Long> value) {
        this.accountDirectorId = ((JAXBElement<Long> ) value);
    }
     ...
     *     
     */
    public Long getUserSalesAccountId() {
     ...
     *     
     */
    public void setUserSalesAccountId(Long value) {
        this.userSalesAccountId = value;
    }
    ...
    /**
     * Gets the value of the routeC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getRouteC() {
        return routeC;
    }

    /**
     * Sets the value of the routeC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setRouteC(JAXBElement<String> value) {
        this.routeC = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the visitFreqC property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<BigDecimal> getVisitFreqC() {
        return visitFreqC;
    }

    /**
     * Sets the value of the visitFreqC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setVisitFreqC(JAXBElement<BigDecimal> value) {
        this.visitFreqC = ((JAXBElement<BigDecimal> ) value);
    }

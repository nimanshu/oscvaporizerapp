 ...
 *         &lt;element name="AccountStatus_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="ContractState_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="Enrollment_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SalesAccountTerritory", propOrder = {
    "lastUpdateDate",
    "lastUpdateLogin",
    "lastUpdatedBy",
    "objectVersionNumber",
...
public class SalesAccountTerritory {
    ...
    @XmlElementRef(name = "AccountStatus_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<String> accountStatusC;
    @XmlElementRef(name = "ContractState_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<String> contractStateC;
    @XmlElementRef(name = "Enrollment_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class)
    protected JAXBElement<String> enrollmentC;
    ...
    /**
     * Gets the value of the accountStatusC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getAccountStatusC() {
        return accountStatusC;
    }

    /**
     * Sets the value of the accountStatusC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setAccountStatusC(JAXBElement<String> value) {
        this.accountStatusC = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the contractStateC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getContractStateC() {
        return contractStateC;
    }

    /**
     * Sets the value of the contractStateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setContractStateC(JAXBElement<String> value) {
        this.contractStateC = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the enrollmentC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getEnrollmentC() {
        return enrollmentC;
    }

    /**
     * Sets the value of the enrollmentC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setEnrollmentC(JAXBElement<String> value) {
        this.enrollmentC = ((JAXBElement<String> ) value);
    }

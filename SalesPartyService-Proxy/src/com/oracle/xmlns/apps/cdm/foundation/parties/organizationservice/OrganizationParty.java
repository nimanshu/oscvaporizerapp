...
import com.oracle.xmlns.apps.cdm.foundation.parties.contactpointservice.Edi;
import com.oracle.xmlns.apps.cdm.foundation.parties.contactpointservice.Eft;
...
import com.oracle.xmlns.apps.cdm.foundation.parties.contactpointservice.Telex;
import com.oracle.xmlns.apps.cdm.foundation.parties.contactpointservice.Web;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.AdditionalPartyId;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.Certification;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.CodeAssignment;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.CreditRating;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.EmailDomain;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.FinancialProfile;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.OriginalSystemReference;
import com.oracle.xmlns.apps.cdm.foundation.parties.partyservice.PartyPreference;
...
@XmlType(name = "OrganizationParty", propOrder = {
    "partyNumber",
    "partyId",
    "partyType",
    "partyName",
...
public class OrganizationParty {
    ...
    @XmlElementRef(name = "SourceSystem", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class)
    protected JAXBElement<String> sourceSystem;
    @XmlElementRef(name = "SourceSystemReferenceValue", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class)
    protected JAXBElement<String> sourceSystemReferenceValue;
    @XmlElementRef(name = "SourceSystemUpdateDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class)

...
public class Asset {
    ...
    @XmlElementRef(name = "AssetAmount", namespace = "http://xmlns.oracle.com/apps/crmCommon/assetImport/publicModel/assetImportService/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "CrmConvRate", namespace = "http://xmlns.oracle.com/apps/crmCommon/assetImport/publicModel/assetImportService/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "SerialNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/assetImport/publicModel/assetImportService/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ExchangeRate", namespace = "http://xmlns.oracle.com/apps/crmCommon/assetImport/publicModel/assetImportService/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "AssetDescription", namespace = "http://xmlns.oracle.com/apps/crmCommon/assetImport/publicModel/assetImportService/", type = JAXBElement.class)
    ...
    public void setAssetAmount(JAXBElement<AmountType> value) {
        this.assetAmount = ((JAXBElement<AmountType> ) value);
    }
    ...
    public void setCrmConvRate(JAXBElement<String> value) {
        this.crmConvRate = ((JAXBElement<String> ) value);
    }
    ...
    public void setAssetDescription(JAXBElement<String> value) {
        this.assetDescription = ((JAXBElement<String> ) value);
    }

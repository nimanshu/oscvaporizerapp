 ...
 *         &lt;element name="BindPartyId" type="{http://www.w3.org/2001/XMLSchema}long"/>
...
@XmlRootElement(name = "findAccountsOfPartyAsync")
public class FindAccountsOfPartyAsync {

    @XmlElement(required = true)
    protected FindCriteria findCriteria;
    @XmlElement(name = "BindPartyId")
    protected long bindPartyId;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the bindPartyId property.
     * 
     */
    public long getBindPartyId() {
        return bindPartyId;
    }

    /**
     * Sets the value of the bindPartyId property.
     * 
     */
    public void setBindPartyId(long value) {
        this.bindPartyId = value;
    }

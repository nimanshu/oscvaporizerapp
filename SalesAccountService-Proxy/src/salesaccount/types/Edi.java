...
public class Edi {
    ...
    @XmlElementRef(name = "EDITransactionHandling", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediTransactionHandling;
    @XmlElementRef(name = "EDIIdNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediIdNumber;
    @XmlElementRef(name = "EDIPaymentMethod", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediPaymentMethod;
    @XmlElementRef(name = "EDIPaymentFormat", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediPaymentFormat;
    @XmlElementRef(name = "EDIRemittanceMethod", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediRemittanceMethod;
    @XmlElementRef(name = "EDIRemittanceInstruction", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> ediRemittanceInstruction;
    @XmlElementRef(name = "EDITpHeaderId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<Long> ediTpHeaderId;
    @XmlElementRef(name = "EDIEceTpLocationCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    ...
    public void setEDITransactionHandling(JAXBElement<String> value) {
        this.ediTransactionHandling = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDIIdNumber(JAXBElement<String> value) {
        this.ediIdNumber = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDIPaymentMethod(JAXBElement<String> value) {
        this.ediPaymentMethod = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDIPaymentFormat(JAXBElement<String> value) {
        this.ediPaymentFormat = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDIRemittanceMethod(JAXBElement<String> value) {
        this.ediRemittanceMethod = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDIRemittanceInstruction(JAXBElement<String> value) {
        this.ediRemittanceInstruction = ((JAXBElement<String> ) value);
    }
    ...
    public void setEDITpHeaderId(JAXBElement<Long> value) {
        this.ediTpHeaderId = ((JAXBElement<Long> ) value);
    }
    ...
    public void setEDIEceTpLocationCode(JAXBElement<String> value) {
        this.ediEceTpLocationCode = ((JAXBElement<String> ) value);
    }

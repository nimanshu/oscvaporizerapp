...
public class Phone {
    ...
    @XmlElementRef(name = "PhoneCallingCalendar", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> phoneCallingCalendar;
    @XmlElementRef(name = "LastContactDtTime", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> lastContactDtTime;
    @XmlElementRef(name = "PhoneAreaCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> phoneAreaCode;
    @XmlElementRef(name = "PhoneCountryCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> phoneCountryCode;
    @XmlElementRef(name = "PhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> phoneNumber;
    @XmlElementRef(name = "PhoneExtension", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> phoneExtension;
    @XmlElement(name = "PhoneLineType")
    protected String phoneLineType;
    @XmlElementRef(name = "RawPhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> rawPhoneNumber;
    @XmlElementRef(name = "PagerTypeCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> pagerTypeCode;
    @XmlElementRef(name = "FormattedPhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> formattedPhoneNumber;
    @XmlElementRef(name = "TransposedPhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> transposedPhoneNumber;
    @XmlElementRef(name = "PartyName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    protected JAXBElement<String> partyName;
    @XmlElementRef(name = "TimezoneCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class)
    ...
    public void setPhoneCallingCalendar(JAXBElement<String> value) {
        this.phoneCallingCalendar = ((JAXBElement<String> ) value);
    }
    ...
    public void setLastContactDtTime(JAXBElement<XMLGregorianCalendar> value) {
        this.lastContactDtTime = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
    ...
    public void setPagerTypeCode(JAXBElement<String> value) {
        this.pagerTypeCode = ((JAXBElement<String> ) value);
    }
    ...
    public void setTransposedPhoneNumber(JAXBElement<String> value) {
        this.transposedPhoneNumber = ((JAXBElement<String> ) value);
    }

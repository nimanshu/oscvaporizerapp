...
@XmlType(name = "OrganizationInformation", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/flex/organization/", propOrder = {
...
public class OrganizationInformation {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/flex/organization/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/flex/organization/", type = JAXBElement.class)
